...
<script src="<?php bloginfo( 'template_url' );?>/bower_components/fancybox/dist/jquery.fancybox.min.js"></script>
<script src="<?php bloginfo( 'template_url' );?>/bower_components/bootstrap/dist/js/bootstrap.min.js"></script>
<script src="<?php bloginfo( 'template_url' );?>/bower_components/angular/angular.min.js"></script>
<script src="<?php bloginfo( 'template_url' );?>/bower_components/angular-sanitize/angular-sanitize.min.js"></script>
...
ga('create','CODEMAN_CODE_HERE','auto');ga('send','pageview');
</script> -->